...
import { crearMateria, editarMateria, eliminarMateria, visualizarMateria, visualizarUnaMateria } from '../controllers/MateriaControlller.js'

const router = Router()

router.post("/materia",verificarTokenJWT, crearMateria )
router.get("/materia",verificarTokenJWT, visualizarMateria )
router.get("/materia/:id",verificarTokenJWT, visualizarUnaMateria )
